...
```json
{
  "source": "data/complex_rag_parsing_sample_with_sunny_image.pdf",
  "page_number": 1,
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_001.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_002.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_003.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_004.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_005.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_006.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_007.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_008.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_009.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_010.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_011.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_012.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_013.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_014.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_015.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_016.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_017.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_018.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_019.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_020.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_021.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_022.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_023.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "data/parsed_complex_pdf_output/page_images/page_024.png"
}
```
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "data/parsed_complex_pdf_output/extracted_images/page_002_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: data/parsed_complex_pdf_output/extracted_images/page_002_image_1.png
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "data/parsed_complex_pdf_output/extracted_images/page_007_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: data/parsed_complex_pdf_output/extracted_images/page_007_image_1.png
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "data/parsed_complex_pdf_output/extracted_images/page_009_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: data/parsed_complex_pdf_output/extracted_images/page_009_image_1.png
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "data/parsed_complex_pdf_output/extracted_images/page_012_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: data/parsed_complex_pdf_output/extracted_images/page_012_image_1.png
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "data/parsed_complex_pdf_output/extracted_images/page_016_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: data/parsed_complex_pdf_output/extracted_images/page_016_image_1.png
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "data/parsed_complex_pdf_output/extracted_images/page_017_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: data/parsed_complex_pdf_output/extracted_images/page_017_image_1.png
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "data/parsed_complex_pdf_output/extracted_images/page_018_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: data/parsed_complex_pdf_output/extracted_images/page_018_image_1.png
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "data/parsed_complex_pdf_output/extracted_images/page_019_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: data/parsed_complex_pdf_output/extracted_images/page_019_image_1.png
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "data/parsed_complex_pdf_output/extracted_images/page_020_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: data/parsed_complex_pdf_output/extracted_images/page_020_image_1.png
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "data/parsed_complex_pdf_output/extracted_images/page_021_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: data/parsed_complex_pdf_output/extracted_images/page_021_image_1.png
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "data/parsed_complex_pdf_output/extracted_images/page_022_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: data/parsed_complex_pdf_output/extracted_images/page_022_image_1.png
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "data/parsed_complex_pdf_output/extracted_images/page_023_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: data/parsed_complex_pdf_output/extracted_images/page_023_image_1.png
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "data/parsed_complex_pdf_output/extracted_images/page_024_image_1.jpeg",
  "image_ext": "jpeg"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: data/parsed_complex_pdf_output/extracted_images/page_024_image_1.jpeg
